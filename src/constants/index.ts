...
export const workExperience = [
    {
        ...
        content: [
            "Reconstructed the client’s e-commerce checkout system, enhancing functionality within a collaborative team.", 
    ...
    },
    {
        ...
        content: [
            "Delivered intuitive user interfaces using React and Typescript, enhancing user experience.", 
    ...
    },
    {
        ...
        content: [
            "Developed and enhanced an in-house cross platform application using Xamarin.", 
    ...
    },
    {
        ...
        role: "Software Engineer",
        content: [
            "Migrated VB6 legacy code to VB.NET and contributed to establishing coding standards for the software migration.", 
            "Developed new applications per client requirements, enhanced existing ones with new features, and implemented API validations.",
